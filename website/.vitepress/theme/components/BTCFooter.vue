        ...
        <div class="footer-grid desktop-only">
          ...
          <div class="links-grid">
            ...
            <div class="links-column">
              ...
              <div
                class="link-section"
                :class="{ 'mt-section': currentContextLinks.length > 0 }"
              >
              ...
              <div class="link-section">
                ...
                <div class="opensource-content">
                  ...
                  <ul class="child-links">
                    <li
                      v-for="child in data.openSource.children"
                      :key="child.label"
                    >
      ...
      <div class="footer-container bottom-container">
        ...
        <div class="bottom-content desktop-only">
          <div class="bottom-left">
            ...
            <span class="separator">•</span>
            <a :href="'mailto:' + data.company.email" class="bottom-link">{{
              data.company.email
            }}</a>
            <span class="separator">•</span>
            <a :href="data.legal.privacyPolicy" class="bottom-link"
              >Privacy Policy</a
            >
          </div>
        </div>
