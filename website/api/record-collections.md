...
- **Parents by relationship name.** Pass the relationship name of the declared lookup, such as `'Account'` for `Contact.AccountId`. A record without a loaded parent adds nothing.
